...
export default function ClientsList() {
    ...
    return (
        <div className="space-y-8 animate-in fade-in duration-500">
                ...
                <div className="flex items-center gap-3 w-full md:w-auto">
                    ...
                    <div className="relative group w-full md:w-64">
                        ...
                        <Input
                            ...
                            className="pl-10 h-10 bg-[#0A0A0A] border-neutral-800 rounded-xl text-xs font-mono text-white placeholder:text-neutral-700 focus:ring-0 focus:border-white transition-colors"
                        />
                    </div>

                    <Dialog open={isDialogOpen} onOpenChange={setIsDialogOpen}>
                        <DialogTrigger asChild>
                            <Button className="h-10 bg-white hover:bg-neutral-200 text-black rounded-xl text-xs font-bold uppercase tracking-wider px-6">
                        ...
                        {/* --- CREATE MODAL --- */}
                        <DialogContent className="bg-[#050505] border-neutral-800 text-white sm:max-w-[500px] p-0 overflow-hidden rounded-xl">
                            ...
                            <form onSubmit={handleSubmit} className="p-6 space-y-5">
                                    ...
                                    <div className="space-y-2 col-span-2">
                                        ...
                                        <div className="relative">
                                            ...
                                            <Input
                                                ...
                                                className="pl-10 bg-neutral-900/50 border-neutral-800 focus:border-white focus:bg-black transition-colors rounded-xl h-11"
                                                autoFocus
                                            />
                                        </div>
                                    </div>
                                        ...
                                        <div className="relative flex gap-2">
                                            <div className="relative flex-1">
                                                ...
                                                <Input
                                                    ...
                                                    className="pl-10 bg-neutral-900/50 border-neutral-800 font-mono text-emerald-500 focus:border-white focus:bg-black transition-colors rounded-xl h-11"
                                                />
                                            </div>
                                ...
                                <DialogFooter className="pt-4">
                                    <Button
                                        ...
                                        className="w-full bg-white hover:bg-neutral-200 text-black font-bold tracking-wider rounded-xl h-12"
                                    >
                                        {isSubmitting ? (
                                            <>
            ...
            {/* Data Grid */}
            <Card className="bg-[#0A0A0A] border-neutral-800 rounded-xl overflow-hidden">
                                ...
                                filteredClients.map((client) => (
                                    <TableRow key={client.id} className="border-neutral-900 hover:bg-neutral-900/30 transition-colors group">
                                        ...
                                        <TableCell className="text-center">
                                            <span className={`inline-flex items-center justify-center min-w-[24px] h-6 px-2 rounded-md text-xs font-mono ${getProjectCount(client.id) > 0
