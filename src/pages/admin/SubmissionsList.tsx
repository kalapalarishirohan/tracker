    ...
    return (
        <div className="space-y-8 animate-in fade-in duration-500">
                                            ...
                                            <tr key={submission.id} className="border-b border-neutral-900 hover:bg-neutral-900/40 transition-colors group">
                                                ...
                                                <td className="px-6 py-4">
                                                    <Badge variant="outline" className={`
                                                        rounded-md text-[10px] font-mono uppercase tracking-widest px-2 py-0.5 border
            ...
            <Dialog open={isViewDialogOpen} onOpenChange={setIsViewDialogOpen}>
                <DialogContent className="bg-[#0A0A0A] border-neutral-800 text-white max-w-lg rounded-xl">
                    <DialogHeader>
                            ...
                            <div className="flex gap-2 pt-4">
                                ...
                                {selectedSubmission.status !== 'archived' && (
                                    <Button
                                        ...
                                        className="flex-1 bg-transparent border-neutral-800 text-neutral-400 hover:text-white hover:bg-neutral-900 rounded-xl"
                                    >
                                        Archive
                                    </Button>
                                )}
