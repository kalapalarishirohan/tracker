                ...
                <div className="flex gap-3">
                    <div className="relative flex-1 max-w-sm group">
                        ...
                        <Input
                            ...
                            className="pl-10 bg-[#0A0A0A] border-neutral-800 rounded-xl text-xs font-mono placeholder:text-neutral-700 focus:ring-0 focus:border-white transition-colors h-10"
                        />
                    </div>
                    <Button variant="outline" className="h-10 w-10 p-0 border-neutral-800 bg-[#0A0A0A] text-neutral-500 hover:text-white rounded-xl">
                                            ...
                                            return (
                                                <TableRow key={ticket.id} className="border-b border-neutral-900 hover:bg-neutral-900/40 transition-colors group">
                                                    ...
                                                    <TableCell className="px-6 py-4">
                                                        ...
                                                        >
                                                            <SelectTrigger className={`w-[130px] h-8 text-[10px] uppercase font-bold tracking-wider rounded-md border transition-all ${getStatusStyle(ticket.status)}`}>
                                                                <SelectValue />
                                                            </SelectTrigger>
                                                    ...
                                                    {/* Priority Badge */}
                                                    <TableCell className="px-6 py-4">
                                                        <Badge variant="outline" className={`rounded-md text-[10px] font-mono uppercase tracking-widest px-2 py-0.5 border ${getPriorityStyle(ticket.priority)}`}>
