...
export default function AdminLayout() {
    ...
    return (
        <div className="flex h-screen bg-[#050505] text-white font-sans selection:bg-blue-500/30 overflow-hidden">
            ...
            {/* ================= SIDEBAR ================= */}
            <aside className="w-72 bg-black border-r border-neutral-800 hidden md:flex flex-col z-20 relative">
                ...
                <div className="h-20 flex items-center px-6 border-b border-neutral-800 bg-black">
                    <div className="flex items-center gap-3">
                        ...
                        <div>
                            <h2 className="text-sm font-medium tracking-tight text-white">Redlix Admin</h2>
                            <p className="text-xs text-neutral-500">System Control</p>
                        </div>
                    </div>
                </div>
                        ...
                        return (
                            <Link key={item.path} to={item.path}>
                                <Button
                                    variant="ghost"
                                    className={cn(
                                        "w-full justify-start gap-3 h-11 rounded-lg mb-1 transition-all duration-300",
                                        isActive
                ...
                <div className="p-4 border-t border-neutral-800 bg-neutral-900/30">
                    ...
                    <Button
                        variant="ghost"
                        className="w-full justify-start gap-2 text-neutral-400 hover:text-red-400 hover:bg-red-950/10 transition-colors h-10 text-xs font-medium"
            ...
            <main className="flex-1 flex flex-col relative z-10 overflow-hidden bg-[#050505]">
                ...
                {/* Top Header */}
                <header className="h-20 border-b border-neutral-800 bg-black/80 backdrop-blur-xl flex items-center justify-between px-8">
                    {/* Breadcrumbs / Page Title */}
                    <div>
                        <h2 className="text-lg font-medium text-white tracking-tight">Dashboard Overview</h2>
                    </div>
