        ...
        <div className="space-y-10 animate-in fade-in duration-500">
            ...
            <div className="flex flex-col md:flex-row md:items-end justify-between gap-4 border-b border-neutral-800 pb-6">
                ...
                <div className="flex gap-2">
                    <div className="bg-neutral-900 border border-neutral-800 px-4 py-2 flex items-center gap-3 rounded-xl">
            ...
            <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-4">
                {stats.map((stat) => (
                    <Card key={stat.label} className="bg-[#0A0A0A] border-neutral-800 rounded-xl hover:border-blue-500 transition-all duration-300 group relative overflow-hidden">

                        <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2 relative z-10">
                            <CardTitle className="text-[10px] font-mono uppercase tracking-widest text-neutral-500">
                                {stat.label}
                            </CardTitle>
                            <stat.icon className={`h-4 w-4 ${stat.alert ? "text-amber-500" : "text-neutral-600 group-hover:text-blue-500 transition-colors"}`} />
                        </CardHeader>
                        <CardContent className="relative z-10">
                            ...
                            <div className="flex justify-between items-end">
                                ...
                                <span className={`text-[10px] px-1.5 py-0.5 rounded-md border ${stat.alert ? "border-amber-900/50 text-amber-500 bg-amber-950/10" : "border-neutral-800 text-neutral-400 bg-neutral-900"}`}>
                                    {stat.trend}
                                </span>
                            </div>
                        </CardContent>
            ...
            <div className="grid gap-6 lg:grid-cols-2">
                {/* Project Requests */}
                <Card className="bg-[#0A0A0A] border-neutral-800 rounded-xl hover:border-blue-500 transition-colors shadow-none">
                                    ...
                                    return (
                                        ...
                                        >
                                            ...
                                            <div className="flex items-center gap-3">
                                                <span className="text-[10px] px-2 py-1 bg-neutral-900 border border-neutral-800 text-neutral-400 rounded-md hidden md:block">
            ...
            <div className="grid gap-6 lg:grid-cols-3">
                ...
                <Card className="lg:col-span-2 bg-[#0A0A0A] border-neutral-800 rounded-xl hover:border-blue-500 transition-colors shadow-none">
                    <CardHeader className="border-b border-neutral-900 py-4 flex flex-row items-center justify-between">
                        <div className="flex items-center gap-2">
                ...
                <Card className="bg-[#0A0A0A] border-neutral-800 rounded-xl hover:border-blue-500 transition-colors shadow-none h-full">
                    ...
                    <CardContent className="p-6 space-y-4">
                        <Link to="/admin/dashboard/clients" className="block">
                            <Button variant="outline" className="w-full justify-between h-12 bg-transparent border-neutral-800 text-neutral-300 hover:text-white hover:bg-neutral-900 hover:border-blue-500 transition-all group rounded-xl">
                                <span className="flex items-center gap-2">
            ...
            <Dialog open={!!selectedSubmission} onOpenChange={() => setSelectedSubmission(null)}>
                <DialogContent className="bg-neutral-950 border-neutral-800 text-white max-w-2xl max-h-[80vh] overflow-y-auto rounded-xl">
                    <DialogHeader>
