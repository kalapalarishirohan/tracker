    ...
    return (
        <div className="space-y-8 animate-in fade-in duration-500">
            ...
            <Dialog open={isDeleteDialogOpen} onOpenChange={setIsDeleteDialogOpen}>
                <DialogContent className="bg-[#050505] border-neutral-800 text-white sm:max-w-[400px] rounded-xl">
                    <DialogHeader>
                    ...
                    <DialogFooter className="gap-2">
                        <Button
                            ...
                            className="border-neutral-800 text-neutral-300 hover:bg-neutral-900 rounded-xl"
                        >
                            Cancel
                        </Button>
                        <Button
            ...
            <div className="grid gap-6">
                {projects.map((project) => {
                    ...
                    return (
                        <Card key={project.id} className="bg-[#0A0A0A] border-neutral-800 rounded-xl shadow-none overflow-hidden group hover:border-blue-500 transition-colors">
                            <CardHeader className="flex flex-row items-start justify-between pb-4 border-b border-neutral-900/50 bg-neutral-950/30">
                                <div className="space-y-1">
                                    <div className="flex items-center gap-3">
                                        ...
                                        <span className={`text-[10px] font-mono px-2 py-0.5 rounded-md border uppercase tracking-widest ${project.is_completed
                                ...
                                <div className="flex items-center gap-2">
                                    {!project.is_completed && (
                                        <Button
                                            ...
                                            className="bg-emerald-950/20 border-emerald-900/50 text-emerald-500 hover:text-white hover:bg-emerald-900/30 text-xs font-mono tracking-wider h-8 rounded-lg"
                                        >
                                    ...
                                    <Dialog open={isDialogOpen && selectedProject?.id === project.id} onOpenChange={(open) => {
                                        ...
                                        <DialogTrigger asChild>
                                            <Button
                                                ...
                                                className="bg-transparent border-neutral-800 text-neutral-400 hover:text-white hover:bg-neutral-900 text-xs font-mono tracking-wider h-8 rounded-lg"
                                            >
                                        ...
                                        {/* --- UPDATE MODAL --- */}
                                        <DialogContent className="bg-[#050505] border-neutral-800 text-white sm:max-w-[450px] p-0 rounded-xl">
                                            ...
                                            <div className="p-6 space-y-8">
                                                <div className="space-y-3">
                                                    ...
                                                    <Select onValueChange={(v) => {
                                                        ...
                                                        <SelectTrigger className="bg-neutral-900 border-neutral-800 rounded-xl text-sm h-11 text-white focus:ring-0 focus:border-white transition-colors">
                                                ...
                                                <Button
                                                    ...
                                                    disabled={isUpdating}
                                                    className="w-full bg-white hover:bg-neutral-200 text-black font-bold h-12 rounded-xl tracking-widest uppercase text-xs"
                                                >
                                                    {isUpdating ? (
                                                        <>
                                                            <Loader2 className="w-4 h-4 mr-2 animate-spin" />
                ...
                {projects.length === 0 && (
                    <div className="h-64 border border-dashed border-neutral-800 rounded-xl flex flex-col items-center justify-center text-neutral-600 space-y-4">
