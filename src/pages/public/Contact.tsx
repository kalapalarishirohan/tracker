                ...
                <div className="w-full md:w-1/3">
                    ...
                    <div className="space-y-6">
                        <div className="space-y-1">
                            <p className="text-[10px] uppercase tracking-widest text-blue-500 font-bold">Email</p>
                            <p className="text-sm text-neutral-300">support.ckrdatapoint@gmail.com</p>
                        </div>
                        <div className="space-y-1">
                            <p className="text-[10px] uppercase tracking-widest text-blue-500 font-bold">Operations</p>
