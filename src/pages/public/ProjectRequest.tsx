...
export default function ProjectRequest() {
            ...
            <div className="h-screen w-full bg-[#050505] text-white flex items-center justify-center p-6 font-light overflow-hidden">
                <div className="text-center space-y-6 max-w-sm bg-[#0A0A0A] border border-neutral-800 p-12 rounded-2xl">
                    ...
                    <Link to="/" className="block pt-4">
                        <Button className="bg-blue-600 hover:bg-blue-700 w-full h-12 font-medium rounded-xl">
                            Return to home
                        </Button>
                    </Link>
                </div>
    ...
    return (
        <div className="h-screen w-full bg-[#050505] text-white flex flex-col font-light selection:bg-blue-500/30 overflow-hidden">
            ...
            <main className="flex-grow flex flex-col md:flex-row max-w-7xl mx-auto w-full px-8 gap-16 items-center pb-12">
                ...
                <div className="w-full md:w-1/3">
                    <h1 className="text-4xl font-normal mb-6 leading-tight">
                        Start your <br />
                        <span className="text-blue-500 font-medium">project request.</span>
                    </h1>
                    ...
                    <form onSubmit={handleSubmit} className="space-y-6">
                        ...
                        <div className="grid md:grid-cols-2 gap-6">
                            <div className="space-y-2">
                                ...
                                <Input
                                    ...
                                    className="h-12 bg-black border-neutral-800 text-white rounded-xl focus:ring-1 focus:ring-blue-600 focus:border-blue-600 outline-none"
                                    required
                                />
                            </div>
                            <div className="space-y-2">
                        ...
                        <div className="grid md:grid-cols-3 gap-6">
                            <div className="space-y-2">
                                ...
                                <Select onValueChange={(v) => setFormData({ ...formData, projectType: v })}>
                                    <SelectTrigger className="h-12 bg-black border-neutral-800 text-white rounded-xl focus:ring-1 focus:ring-blue-600 focus:border-blue-600 outline-none">
                                        <SelectValue placeholder="Select type" />
                                    </SelectTrigger>
                                    <SelectContent className="bg-[#0A0A0A] border-neutral-800 text-white">
                                        <SelectItem value="web" className="focus:bg-blue-600 focus:text-white">Web application</SelectItem>
                                        <SelectItem value="mobile" className="focus:bg-blue-600 focus:text-white">Mobile application</SelectItem>
                                        <SelectItem value="other" className="focus:bg-blue-600 focus:text-white">Other</SelectItem>
                                    </SelectContent>
                                </Select>
                            </div>
                            <div className="space-y-2">
                                ...
                                <Select onValueChange={(v) => setFormData({ ...formData, budget: v })}>
                                    ...
                                    <SelectContent className="bg-[#0A0A0A] border-neutral-800 text-white">
                                        <SelectItem value="small" className="focus:bg-blue-600 focus:text-white">Under ₹50k</SelectItem>
                                        <SelectItem value="medium" className="focus:bg-blue-600 focus:text-white">₹50k - ₹1L</SelectItem>
                                        <SelectItem value="large" className="focus:bg-blue-600 focus:text-white">₹1L+</SelectItem>
                                    </SelectContent>
                                </Select>
                            </div>
                            <div className="space-y-2">
                                ...
                                <Select onValueChange={(v) => setFormData({ ...formData, timeline: v })}>
                                    ...
                                    <SelectContent className="bg-[#0A0A0A] border-neutral-800 text-white">
                                        <SelectItem value="urgent" className="focus:bg-blue-600 focus:text-white">Urgent</SelectItem>
                                        <SelectItem value="standard" className="focus:bg-blue-600 focus:text-white">Standard</SelectItem>
                                        <SelectItem value="flexible" className="focus:bg-blue-600 focus:text-white">Flexible</SelectItem>
                                    </SelectContent>
                                </Select>
                            </div>
                        </div>
                        ...
                        <div className="space-y-2">
                            ...
                            <Textarea
                                ...
                                rows={3}
                                className="bg-black border-neutral-800 text-white rounded-xl focus:ring-1 focus:ring-blue-600 focus:border-blue-600 outline-none resize-none"
                            />
                        </div>
