        ...
        <div className="min-h-screen bg-[#050505] text-white font-light flex flex-col selection:bg-blue-500/30">
            ...
            <div className="max-w-6xl mx-auto px-8 py-16 text-center">
                <h1 className="text-4xl md:text-5xl font-normal mb-6 tracking-tight">
                    Transparent <span className="text-blue-500">Service Pricing.</span>
                </h1>
...
function ServiceCard({ icon: Icon, title, price, suffix, description, features, highlight }: ServiceCardProps) {
    return (
        <div className={`flex flex-col p-8 rounded-2xl border transition-all duration-300 ${highlight ? 'bg-[#0A0A0A] border-blue-500/50 shadow-2xl shadow-blue-900/10' : 'bg-[#0A0A0A] border-neutral-800 hover:border-neutral-700'}`}>
            <div className="mb-6">
                <div className={`w-12 h-12 rounded-xl flex items-center justify-center mb-6 ${highlight ? 'bg-blue-600/10 text-blue-500' : 'bg-neutral-900 text-white'}`}>
            ...
            <div className="flex-grow space-y-3 mb-8">
                {features.map((feature, idx) => (
                    <div key={idx} className="flex items-start gap-3">
                        <Check className={`w-4 h-4 mt-0.5 shrink-0 ${highlight ? 'text-blue-500' : 'text-neutral-600'}`} />
            ...
            <Link to="/request-project" className="mt-auto">
                <Button className={`w-full h-12 font-medium rounded-xl transition-all ${highlight ? 'bg-blue-600 hover:bg-blue-700 text-white' : 'bg-white text-black hover:bg-neutral-200'}`}>
                    Start Project
                </Button>
            </Link>
        </div>
            ...
            <div className="mb-6">
                ...
                <div className="space-y-4">
                    <div className="p-4 rounded-xl bg-[#0A0A0A] border border-neutral-800">
                        ...
                        <p className="text-white font-mono text-sm">UPI: redlix@okhdfcbank</p>
