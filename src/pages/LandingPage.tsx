...
function PortalCard({ title, desc, link, button }) {
  return (
    <div className="border border-neutral-800 bg-[#0A0A0A] p-8 rounded-xl hover:border-blue-500 transition-colors">
      ...
      <Link to={link} className="text-blue-500 text-sm font-medium hover:text-blue-400">
        {button} →
      </Link>
    </div>
  );
